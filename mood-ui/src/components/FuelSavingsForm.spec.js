...
describe('<FuelSavingsForm />', () => {
  it('should contain <FuelSavingsTextInput /> components', () => {
    ...
    const wrapper = shallow(
      <FuelSavingsForm onSaveClick={jest.fn()} onChange={jest.fn()} fuelSavings={fuelSavings} />
    );
  ...
  it('should submit appState', () => {
    ...
    const onSaveClick = jest.fn();
    const wrapper = shallow(
      <FuelSavingsForm onSaveClick={onSaveClick} onChange={jest.fn()} fuelSavings={fuelSavings} />
    );
  ...
  it('should call onChange when text input changes', () => {
    ...
    const wrapper = shallow(
      <FuelSavingsForm onSaveClick={jest.fn()} onChange={onChange} fuelSavings={getFuelSavings()} />
    );
  ...
  it('should call onChange when timeframe changes', () => {
    ...
    const wrapper = shallow(
      <FuelSavingsForm onSaveClick={jest.fn()} onChange={onChange} fuelSavings={fuelSavings} />
    );
